...
#define UWORLD_CLEANUPWORLDINTERNAL "4C 8B DC 55 53 41 54 41 56 41 57 49 8D 6B ?? 48 81 EC ?? ?? ?? ?? 8B 05 ?? ?? ?? ?? 4D 8B E1 45 0F B6 F0 44 0F B6 FA 48 8B D9 39 81 ?? ?? ?? ?? 0F 84 ?? ?? ?? ??"
...
#define UMENUWIDGET_OPENMENU "48 89 54 24 ?? 55 53 56 57 41 54 41 55 48 8D 6C 24 ?? 48 81 EC ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 48 33 C4"//1.9 version: "41 80 F8 ?? 0F 84 ?? ?? ?? ?? 55 57 41 56 48 83 EC ?? 48 89 5C 24 ?? 41 0F B6 E8"
